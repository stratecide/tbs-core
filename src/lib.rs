...
mod tests {
    ...
    fn export_game() {
        ...
        map.set_unit(Point::new(0, 2), Some(UnitType::normal(NormalUnits::Hovercraft(true), crate::player::OWNER_0)));
        map.set_unit(Point::new(6, 2), Some(UnitType::normal(NormalUnits::Hovercraft(true), crate::player::OWNER_1)));
