        ...
        map.set_unit(
            ...
            Some(
                UnitType::PAWN
                    ...
                    .set_tag(
                        TAG_PAWN_DIRECTION,
                        crate::tags::TagValue::Direction(Direction4::D270),
                    )
                    .set_owner_id(1)
                    .build(),
            ),
        ...
        map.set_unit(
            ...
            Some(
                UnitType::PAWN
                    ...
                    .set_tag(
                        TAG_PAWN_DIRECTION,
                        crate::tags::TagValue::Direction(Direction4::D90),
                    )
                    .set_owner_id(0)
                    .build(),
            ),
...
fn simple_distortions() {
    ...
    assert_eq!(
        distortion.update_direction(Direction6::D0),
        Direction6::D240
    );
    assert_eq!(
        distortion.update_direction(Direction6::D60),
        Direction6::D180
    );
    assert_eq!(
        distortion.update_direction(Direction6::D120),
        Direction6::D120
    );
    assert_eq!(
        distortion.update_direction(Direction6::D180),
        Direction6::D60
    );
    assert_eq!(
        distortion.update_direction(Direction6::D240),
        Direction6::D0
    );
    assert_eq!(
        distortion.update_direction(Direction6::D300),
        Direction6::D300
    );
    assert_eq!(
        distortion.update_diagonal_direction(Direction6::D0),
        Direction6::D180
    );
    assert_eq!(
        distortion.update_diagonal_direction(Direction6::D60),
        Direction6::D120
    );
    assert_eq!(
        distortion.update_diagonal_direction(Direction6::D120),
        Direction6::D60
    );
    assert_eq!(
        distortion.update_diagonal_direction(Direction6::D180),
        Direction6::D0
    );
    assert_eq!(
        distortion.update_diagonal_direction(Direction6::D240),
        Direction6::D300
    );
    assert_eq!(
        distortion.update_diagonal_direction(Direction6::D300),
        Direction6::D240
    );
}
