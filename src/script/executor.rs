...
impl<'a> Executor<'a> {
    ...
    pub fn run_ast<D: Direction, T: Any>(
        ...
        let result: Dynamic =
            engine.call_fn_with_options(options, &mut scope, ast, function, args)?;
